...
class RegisterDelivererScreen extends ConsumerStatefulWidget {
  const RegisterDelivererScreen({super.key});

  @override
  ConsumerState<RegisterDelivererScreen> createState() =>
      _RegisterDelivererScreenState();
}

class _RegisterDelivererScreenState
    extends ConsumerState<RegisterDelivererScreen> {
  ...
  VehicleType _vehicleType = VehicleType.FOURGON;
  ...
  Future<void> _submit() async {
    ...
    try {
      await ref.read(authProvider.notifier).registerDeliverer({
        ...
        if (_matriculeCtrl.text.isNotEmpty)
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  IconButton(
                    onPressed: () =>
                        context.go('${AppRoutes.login}?role=DELIVERER'),
                  ...
                  _f(_phoneCtrl, 'Phone Number', Icons.phone_outlined,
                  ...
                  // ── Wilaya dropdown — GET /geo/wilayas ────────────────────
                  wilayasAsync.when(
                  ...
                  TextFormField(
                    ...
                    style: const TextStyle(color: Colors.white),
                    decoration: const InputDecoration(
                      labelText: 'Vehicle Matricule (optional)',
